...
public class Carro {
    ...
    private Carro(Motorista motorista, String placa, Cor cor) {
        if(placa == null || cor == null) throw new NullPointerException("Preencha todos os campos");
        if(placa.isEmpty()) throw new EstacionamentoException("O carro deve conter uma placa");
        if(motorista == null) throw new EstacionamentoException("Não há motorista");
