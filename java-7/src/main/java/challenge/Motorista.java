...
public class Motorista {
    ...
    private Motorista(String nome, int idade, int pontos, String habilitacao) {
        if(nome == null || habilitacao == null) throw new NullPointerException("Preencha todos os campos");
        if(nome.isEmpty() || habilitacao.isEmpty()) throw new EstacionamentoException("Preencha todos os campos");
